...
def update_joysticks(self):
        ...
        a_js_left_y	    =round(button_analog[1],accuracy) * (-1)
        a_js_right_x	    =round(button_analog[3],accuracy)
...
def update_buttons(self):
        ...
        b_cross		=button_state[0]
        b_circle	=button_state[1]
        b_triangle	=button_state[2]
        b_square	=button_state[3]
        
        b_select	=button_state[8]
        b_start	    =button_state[9]
        b_ps		=button_state[10]
        ...
        while not contr_found:
            ...
            if contoller_count > 0:
                for i in range(contoller_count):
                    contr = pygame.joystick.Joystick(i)
                    contr.init()
